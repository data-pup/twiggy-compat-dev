    ...
    R: gimli::Reader,
{
    ...
    let kind = match tag {
        ...
        gimli::DW_TAG_array_type => ir::ItemKind::Data(),
        gimli::DW_TAG_class_type => ir::ItemKind::Data(),
        gimli::DW_TAG_entry_point => unimplemented!(),
        gimli::DW_TAG_enumeration_type => ir::ItemKind::Data(),
        ...
        gimli::DW_TAG_pointer_type => ir::ItemKind::Data(),
        gimli::DW_TAG_reference_type => ir::ItemKind::Data(),
        gimli::DW_TAG_compile_unit => ir::ItemKind::Code(),
        gimli::DW_TAG_string_type => ir::ItemKind::Data(),
        gimli::DW_TAG_structure_type => ir::ItemKind::Data(),
        gimli::DW_TAG_subroutine_type => ir::ItemKind::Data(),
        gimli::DW_TAG_typedef => unimplemented!(),
        gimli::DW_TAG_union_type => ir::ItemKind::Data(),
